...
export default async function HealthPage() {
  ...
  return <div className="page-wrap">
    <PageHeader eyebrow="End-to-end monitoring" title="Gateway health" description="A successful check proves the public Caddy route, Nginx authentication, CLIProxyAPI authentication, and upstream response all completed." actions={<HealthButton />} />
