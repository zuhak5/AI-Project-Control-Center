...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return <main className="login-page"><div className="login-grid-bg" /><section className="login-card">
    ...
    <div className="login-copy"><p className="eyebrow">Private operator console</p><h1>One console for the complete HomePilot AI gateway.</h1><p>Test the fixed Caddy endpoint, monitor end-to-end health, inspect sanitized request metadata, and verify Vercel configuration without exposing either gateway credential.</p></div>
    ...
    <div className="login-notes"><span>Google Cloud VM</span><span>Caddy + Nginx</span><span>CLIProxyAPI</span></div>
  </section></main>;
}
